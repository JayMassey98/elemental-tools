...
# N/E/S/W - Campfires
$execute if block ~ ~ ~ #minecraft:campfires[signal_fire=false] run return run function elemental_tools:generic/block/facing/campfires {states:2,lit:"false",facing:"$(facing)",signal_fire:"false",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:campfires[signal_fire=true] run return run function elemental_tools:generic/block/facing/campfires {states:4,lit:"false",facing:"$(facing)",signal_fire:"true",waterlogged:"$(waterlogged_next)"}

# N/E/S/W - Copper Chests
$execute if block ~ ~ ~ #minecraft:copper_chests[type=single] run return run function elemental_tools:generic/block/facing/copper_chests {states:2,facing:"$(facing)",type:"single",waterlogged:"$(waterlogged_next)"}

# N/E/S/W - Copper Golem Statues
$execute if block ~ ~ ~ #minecraft:copper_golem_statues[copper_golem_pose=sitting] run return run function elemental_tools:generic/block/facing/copper_golem_statues {states:2,copper_golem_pose:"sitting",facing:"$(facing)",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:copper_golem_statues[copper_golem_pose=standing] run return run function elemental_tools:generic/block/facing/copper_golem_statues {states:2,copper_golem_pose:"standing",facing:"$(facing)",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:copper_golem_statues[copper_golem_pose=running] run return run function elemental_tools:generic/block/facing/copper_golem_statues {states:2,copper_golem_pose:"running",facing:"$(facing)",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:copper_golem_statues[copper_golem_pose=star] run return run function elemental_tools:generic/block/facing/copper_golem_statues {states:2,copper_golem_pose:"star",facing:"$(facing)",waterlogged:"$(waterlogged_next)"}
...
# N/E/S/W - Stairs
$execute if block ~ ~ ~ #minecraft:stairs[half=bottom] run return run function elemental_tools:generic/block/facing/stairs {states:2,facing:"$(facing)",half:"bottom",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:stairs[half=top] run return run function elemental_tools:generic/block/facing/stairs {states:2,facing:"$(facing)",half:"top",waterlogged:"$(waterlogged_next)"}

# N/E/S/W - Trapdoors
$execute if block ~ ~ ~ #minecraft:trapdoors[half=bottom,open=false] run return run function elemental_tools:generic/block/facing/trapdoors {states:2,facing:"$(facing)",half:"bottom",open:"false",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:trapdoors[half=bottom,open=true] run return run function elemental_tools:generic/block/facing/trapdoors {states:2,facing:"$(facing)",half:"bottom",open:"true",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:trapdoors[half=top,open=false] run return run function elemental_tools:generic/block/facing/trapdoors {states:2,facing:"$(facing)",half:"top",open:"false",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:trapdoors[half=top,open=true] run return run function elemental_tools:generic/block/facing/trapdoors {states:2,facing:"$(facing)",half:"top",open:"true",waterlogged:"$(waterlogged_next)"}
...
# N/E/S/W - Wall Hanging Signs
$execute if block ~ ~ ~ acacia_wall_hanging_sign run return run setblock ~ ~ ~ acacia_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ bamboo_wall_hanging_sign run return run setblock ~ ~ ~ bamboo_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ birch_wall_hanging_sign run return run setblock ~ ~ ~ birch_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ cherry_wall_hanging_sign run return run setblock ~ ~ ~ cherry_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ crimson_wall_hanging_sign run return run setblock ~ ~ ~ crimson_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ dark_oak_wall_hanging_sign run return run setblock ~ ~ ~ dark_oak_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ jungle_wall_hanging_sign run return run setblock ~ ~ ~ jungle_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ mangrove_wall_hanging_sign run return run setblock ~ ~ ~ mangrove_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ oak_wall_hanging_sign run return run setblock ~ ~ ~ oak_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ pale_oak_wall_hanging_sign run return run setblock ~ ~ ~ pale_oak_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ spruce_wall_hanging_sign run return run setblock ~ ~ ~ spruce_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ warped_wall_hanging_sign run return run setblock ~ ~ ~ warped_wall_hanging_sign[facing=$(facing),waterlogged=$(waterlogged_next)]
...
$execute if block ~ ~ ~ trapped_chest[type=single] run return run setblock ~ ~ ~ trapped_chest[type=single,facing=$(facing),waterlogged=$(waterlogged_next)]

# N/E/S/W - Wooden Shelves
$execute if block ~ ~ ~ #minecraft:wooden_shelves[powered=false,side_chain=center] run return run function elemental_tools:generic/block/facing/wooden_shelves {states:2,facing:"$(facing)",powered:"false",side_chain:"center",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:wooden_shelves[powered=false,side_chain=left] run return run function elemental_tools:generic/block/facing/wooden_shelves {states:2,facing:"$(facing)",powered:"false",side_chain:"left",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:wooden_shelves[powered=false,side_chain=right] run return run function elemental_tools:generic/block/facing/wooden_shelves {states:2,facing:"$(facing)",powered:"false",side_chain:"right",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:wooden_shelves[powered=false,side_chain=unconnected] run return run function elemental_tools:generic/block/facing/wooden_shelves {states:2,facing:"$(facing)",powered:"false",side_chain:"unconnected",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:wooden_shelves[powered=true,side_chain=center] run return run function elemental_tools:generic/block/facing/wooden_shelves {states:2,facing:"$(facing)",powered:"true",side_chain:"center",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:wooden_shelves[powered=true,side_chain=left] run return run function elemental_tools:generic/block/facing/wooden_shelves {states:2,facing:"$(facing)",powered:"true",side_chain:"left",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:wooden_shelves[powered=true,side_chain=right] run return run function elemental_tools:generic/block/facing/wooden_shelves {states:2,facing:"$(facing)",powered:"true",side_chain:"right",waterlogged:"$(waterlogged_next)"}
$execute if block ~ ~ ~ #minecraft:wooden_shelves[powered=true,side_chain=unconnected] run return run function elemental_tools:generic/block/facing/wooden_shelves {states:2,facing:"$(facing)",powered:"true",side_chain:"unconnected",waterlogged:"$(waterlogged_next)"}
