...
$execute if block ~ ~ ~ cinnabar_brick_wall run return run setblock ~ ~ ~ cinnabar_brick_wall[east=$(east),north=$(north),south=$(south),up=$(up),west=$(west),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ cinnabar_wall run return run setblock ~ ~ ~ cinnabar_wall[east=$(east),north=$(north),south=$(south),up=$(up),west=$(west),waterlogged=$(waterlogged_next)]
...
$execute if block ~ ~ ~ polished_cinnabar_wall run return run setblock ~ ~ ~ polished_cinnabar_wall[east=$(east),north=$(north),south=$(south),up=$(up),west=$(west),waterlogged=$(waterlogged_next)]
...
$execute if block ~ ~ ~ polished_sulfur_wall run return run setblock ~ ~ ~ polished_sulfur_wall[east=$(east),north=$(north),south=$(south),up=$(up),west=$(west),waterlogged=$(waterlogged_next)]
...
$execute if block ~ ~ ~ sulfur_brick_wall run return run setblock ~ ~ ~ sulfur_brick_wall[east=$(east),north=$(north),south=$(south),up=$(up),west=$(west),waterlogged=$(waterlogged_next)]
$execute if block ~ ~ ~ sulfur_wall run return run setblock ~ ~ ~ sulfur_wall[east=$(east),north=$(north),south=$(south),up=$(up),west=$(west),waterlogged=$(waterlogged_next)]
